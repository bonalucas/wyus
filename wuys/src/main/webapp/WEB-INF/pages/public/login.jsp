...
<body>
    <div id="div1">
        <div id="sp1">登录</div>
        <form action="${pageContext.request.contextPath}/reception/user/doLogin" method="post">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <input type="text" class="txt" name="userid" id="userid" placeholder="请输入账号">
                    </td>
                </tr>
                <tr>
                    <td><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
                    ...
                    <td>
                        <input type="password" class="txt" id="currpwd" placeholder="请输入密码">
                    </td>
                </tr>
                <tr>
                    <td><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
                ...
                <tr>
                    <td></td>
                    <td>
                        <input class="sub" type="submit" id="login" value="登&nbsp;&nbsp;录">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <script type="text/javascript">
        ...
        $("#register").click(function (){
            window.location.href="${pageContext.request.contextPath}/reception/toRegister";
        });
